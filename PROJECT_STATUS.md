...
| P5-B | Not started | Smallest viable implementation slice per `docs/P5_V4_FLASH_EXPERIMENTAL_PROFILE_PLAN.md` §5. Adds the `v4_flash_local_experimental` profile entry + minimal allowlist alignment + focused tests + stale-doc reconciliation. Requires separate approval after P5-A. |
