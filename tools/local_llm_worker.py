...
Only report comments actually present. Do NOT invent any.""",
    ...
    "find-related-files": """Given this query/task description and file listing, identify the most relevant
...
Keep it concise.""",
    ...
    "draft-commit-message": """Draft a commit message from the provided git diff. Output:
...
- Keep the message generic and project-agnostic""",
    ...
    "draft-pr-summary": """Draft a PR summary from the provided git diff or commit range. Output:
...
- Keep the summary generic and project-agnostic""",
    ...
    "draft-changelog-entry": """Draft a changelog entry from the provided git diff or commit range. Output:
